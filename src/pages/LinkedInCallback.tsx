...
export default function LinkedInCallback() {
  ...
  useEffect(() => {
    ...
    if (err) {
      setStatus('error')
      setError('LinkedIn login was cancelled or denied.')
      return
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a]">
      <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-10 w-full max-w-sm text-center shadow-2xl">
        ...
        {status === 'loading' && (
          <>
            <div className="w-12 h-12 border-2 border-[#0A66C2] border-t-transparent rounded-full animate-spin mx-auto mb-5" />
            <p className="text-white font-medium">Connecting LinkedIn...</p>
