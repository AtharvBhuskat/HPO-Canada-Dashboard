...
export default function TikTokCallback() {
  ...
  useEffect(() => {
    ...
    if (err) {
      setStatus('error')
      setError('TikTok login was cancelled or denied.')
      return
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a]">
      <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-10 w-full max-w-sm text-center shadow-2xl">
        ...
        {status === 'loading' && (
          <>
            <div className="w-12 h-12 border-2 border-[#FE2C55] border-t-transparent rounded-full animate-spin mx-auto mb-5" />
            <p className="text-white font-medium">Connecting TikTok...</p>
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-white font-medium">TikTok Connected!</p>
        ...
        {status === 'error' && (
          <>
            ...
            <button
              ...
              className="mt-5 px-5 py-2 text-white text-sm rounded-lg font-medium transition-opacity hover:opacity-80"
